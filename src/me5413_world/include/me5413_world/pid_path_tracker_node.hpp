/** pid_path_tracker_node.hpp
 *
 * Copyright (C) 2024 Shuo SUN & Advanced Robotics Center, National University of Singapore
 *
 * MIT License
 *
 * Declarations for PidPathTrackerNode class
 */

#ifndef PID_PATH_TRACKER_NODE_H_
#define PID_PATH_TRACKER_NODE_H_
...
#include <me5413_world/pid_path_trackerConfig.h>
...
class PidPathTrackerNode
{
 public:
  PidPathTrackerNode();
  virtual ~PidPathTrackerNode() {};
 ...
 private:
  ...
  dynamic_reconfigure::Server<me5413_world::pid_path_trackerConfig> server;
  dynamic_reconfigure::Server<me5413_world::pid_path_trackerConfig>::CallbackType f;
...
#endif // PID_PATH_TRACKER_NODE_H_
